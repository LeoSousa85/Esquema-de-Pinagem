...
import 'a_pagina_ex_model.dart';
export 'a_pagina_ex_model.dart';

class APaginaExWidget extends StatefulWidget {
  const APaginaExWidget({super.key});

  @override
  State<APaginaExWidget> createState() => _APaginaExWidgetState();
}

class _APaginaExWidgetState extends State<APaginaExWidget> {
  late APaginaExModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APaginaExModel());
